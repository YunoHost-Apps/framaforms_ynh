...
# Yakforms (formerly Framaforms) for YunoHost
...
Yakforms, formerly Framaforms, is an online forms and surveys service. Registered users are allowed to create forms, share them, collect and visualize results through a simple interface.
